package com.kh.pratice4;

import java.util.Map;
import java.util.Scanner;

import com.kh.pratice4.controller.MemberController;
import com.kh.pratice4.model.Member;
...
public class Application {
	...
	public void changeName() {
		...
		System.out.println("현재 설정된 이름은 : " + 	mc.login(id, password));
		System.out.print("현재 변경할 이름은 : " );
		String name = sc.nextLine();
