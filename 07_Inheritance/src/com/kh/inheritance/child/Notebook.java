 ...
 * [표현법]
 * 
 * [접근제어자] class 자식 클래스 extends 부모클래스 {
 * 
 *          // 멤버변수
 *          // 생성자
 *          // 메서드
 ...
 * -> Object 클래스에서 제공하는 메서들을 오버라이딩하며 메서드 재정의가 가능
...
//		setPrice(price);
		...
		//3. 부모 생성자 호출에서 초기화
		super(brand, pCode, name, price); // 생성자에서 담을 수 있음.
		this.cpu = cpu;
	}

	@Override
	public String toString() {
		return super.toString() + " , Notebook [cpu=" + cpu + "]"; //부모꺼 가져올수있음.
	}
