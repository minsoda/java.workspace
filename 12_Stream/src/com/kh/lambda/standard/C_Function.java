...
//		Function<Student, String> function = s -> s.getName();
		Function<Student, String> funciton = Student::getName;
		System.out.println("이름 : " + funciton.apply(student));
	}
	

	//BiFunction<T, U, R> : 객체 T와 U를 R로 매핑
	public void method2() {
		BiFunction<String, Integer, Student> biFunciton = (name, age)
		-> new Student(name, age);
		System.out.println(biFunciton.apply("최승환", 15));
	}
