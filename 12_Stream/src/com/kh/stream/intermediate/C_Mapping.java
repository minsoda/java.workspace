...
//		c.method2();
	...
	public void method2() {
		...
		List<String>list = Arrays.asList("Java11 Lmbda", "StreamAPI Filtering Sorted Mapping");
		
		list.stream()
		.flatMap(str -> Arrays.stream(str.split(" "))) //띄어쓰기 부분을 구분해주겠노라아아아아아ㅏ
		.forEach(str -> System.out.println(str));
	}
	
	
	//asDoubleStream() : IntStream, LongStream을 DoublStream으로 변환
	public void method3() {
